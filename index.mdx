...
<Columns cols={2}>
  <Card title="Edit locally" icon="pen-to-square" horizontal href="/development">
...
<Columns cols={2}>
  ...
  <Card title="Images" icon="image" iconType="duotone" color="#c71515" href="/essentials/images">
